  ...
  try {
    ...
    const rows = await pool.query(
      ...
      SELECT
        ...
        $21::numeric AS approved_hours_this_month,
        to_char($22::date, 'YYYY-MM-DD') AS month_from,
        to_char($23::date, 'YYYY-MM-DD') AS month_to_inclusive,
        $24::int AS next_shift_assignment_id,
        CASE WHEN $25::date IS NULL THEN NULL ELSE to_char($25::date, 'YYYY-MM-DD') END AS next_shift_date,
        $26::text AS next_shift_department_desc,
        $27::text AS next_shift_division_desc,
        $28::text AS next_shift_label,
        $29::time AS next_shift_start_time,
        $30::time AS next_shift_end_time,
        $31::numeric AS next_shift_duration_hours
      `,
      [
        baseRow.user_id,
        baseRow.user_name,
